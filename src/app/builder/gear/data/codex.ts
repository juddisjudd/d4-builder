...
export const codex: AspectData[] = [
  ...
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Lucky Hit', 'Vulnerable'],
    description:
      "Lucky Hit: Up to a [20-35%] chance for your Skills to inflict Vampiric Curse on enemies. Enemies afflicted with Vampiric Curse are also Vulnerable.\n\nVampiric Curse's stored souls deal [20-50%] increased damage.",
  },
  {
  ...
  },
  {
    ...
    filters: ['Lucky Hit'],
    description:
      'Lucky Hit: Damaging enemies with Leap, Upheaval, or Whirlwind have up to a [45-60%] chance to summon an Ancient to perform the same Skill.',
  },
  {
  ...
  },
  {
    ...
    description:
      "While both bonuses from Esu's Ferocity Key Passive are active, your Attack Speed is increased by [35-50%] .",
  },
  {
  ...
  },
  {
    ...
    filters: ['Lucky Hit'],
    description:
      'Lucky Hit: Your Marksman Skills have up to a 25% chance to create an Arrow Storm at the enemy’s location, dealing [X] Physical damage over 3 seconds.\n\nYour Arrow Storms deal [25-35%] increased damage.',
  },
  {
    ...
    campaign: false,
    description:
      'When you spend 75 Energy you release a cluster of exploding Stun Grenades that deal [X] total Physical damage and Stun enemies for 1 second.\n\nYour Grenade Skills deal [25-45%] increased damage.',
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Close Enemies', 'Stun'],
    description:
      'When there are at least 5 Close enemies, Stun them for [3-4] seconds. This can only occur once every 20 seconds.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Dealing direct damage while Berserking inflicts [15-30%] of the Base damage as additional Bleeding damage over 5 seconds.',
  },
  {
  ...
  },
  {
    ...
    location: 'Hawezar',
    description:
      "Increase the damage of arrows that ricochet from Barrage from 40% to [50-80%] . Barrage's arrows have a [30-60%] chance to split into 2 arrows whenever they ricochet.",
  },
  {
    ...
    description:
      'Leap creates an Earthquake that deals [X] Physical damage over 4 seconds. While standing in Earthquakes, you gain [10-25%] increased Damage Reduction.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Lucky Hit: Poison Imbued Skills have up to a 15% chance to create a toxic pool that deals [X] Poisoning damage over 3 seconds to enemies within. While standing in the pool, your Poison Imbuement Skill has no Cooldown and no charge limit.',
  },
  {
  ...
  },
  {
    ...
    location: 'Kehjistan',
    filters: ['Freeze', 'Immobilize', 'Stun'],
  ...
  },
  {
    ...
    filters: ['Damage Reduction'],
    description:
      'Cyclone Armor also provides Physical Damage Reduction. In addition, Cyclone Armor will be applied to all Nearby Allies.',
  },
  {
    ...
    campaign: false,
    description:
      "Each time the Shadowblight Key Passive deals damage to enemies, it increases the next Shadowblight's damage within 10 seconds by x [30-45%] , stacking up to 5 times.",
  },
  {
    ...
    location: 'Kehjistan',
    description:
      'You gain [0.4-0.7%] increased Armor for 4 seconds when you deal any form of damage, stacking up to [25-40%] .',
  },
  {
  ...
  },
  {
    ...
    campaign: false,
    description:
      'Gain x [20-30%] increased damage to a set of damage types for 7 seconds. This effect alternates between 2 sets:\n• Fire, Lightning, and Physical.\n• Cold, Poison, and Shadow.',
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Dodge', 'Close Enemies'],
    description:
      "While you have both bonuses from the Close Quarters Combat Key Passive active, your Dodge Chance increases by [4-7%] whenever you're hit by an enemy. Successfully Dodging resets this bonus.",
  },
  {
    ...
    location: 'Scosglen',
    description:
      'Damaging enemies with Sever has a [10-25%] chance to spawn a pool of Blight under the target that deals x [40-100%] bonus damage. This effect can only happen once every 3 seconds.',
  },
  {
  ...
  },
  {
    ...
    campaign: false,
    description:
      'After spending 100 Fury, your next Weapon Mastery Skills within 5 seconds deals x [40-70%] increased damage.',
  },
  {
    ...
    filters: ['Burn'],
    description:
      'You deal [15-30%] increased Burning damage to enemies below 50% Life. Additionally, you deal [70-100%] increased Burning damage to enemies while they are affected by more Damage Over Time than their total Life.',
  },
  {
    ...
    campaign: false,
    description:
      'Blood Mist triggers Corpse Explosion on surrounding Corpses. When Blood Mist detonates a Corpse, its Cooldown is reduced by [0.1-0.6] seconds.',
  },
  {
    ...
    description:
      'Your Grenade Skills count as Trap Skills. Whenever you arm a Trap or drop Grenades, you gain [10-25%] increased Movement speed for 3 seconds.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Damage Reduction'],
    description:
      'When you hit at least 1 enemy with Maul, increase its Attack Speed by [1-2.5%] and you gain [1-4%] Damage reduction for 5 seconds, stacking up to 5 times.',
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Shout', 'Dust Devils'],
    description:
      'Your Shout Skills create 3 Dust Devils that deal [X] damage to enemies along their path.\nYour Dust Devils are [5-20%] bigger and deal 1% increased damage for each 1% their size is increased.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Attack Speed'],
    description:
      'Each time one of your Summoning Minions damages an enemy, they gain [10-15%] Attack Speed for 3 seconds, up to [30-45%] .',
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Vulnerable', 'Freeze', 'Cold Damage'],
    description:
      'While below [45-55%] Life, Evade Freezes Close enemies, deals [X] Cold Damage to them, and makes them Vulnerable for 3 seconds.',
  },
  {
  ...
  },
  {
    ...
    campaign: false,
    description:
      'Reduces the Cooldown of Leap by [2.5-5] seconds per enemy hit, up to a maximum of 9 seconds. Hitting a Boss with Leap provides the maximum cooldown reduction.',
  },
  {
    ...
    location: 'Kehjistan',
    description:
      'Gain [10-25%] increased Critical Strike Chance for 6 seconds when you cast Corpse Tendrils. You deal x [20-50%] bonus Critical Strike Damage to enemies damaged by Corpse Tendrils.',
  },
  {
  ...
  },
  {
    ...
    campaign: false,
    description:
      'Each cast of Blood Lance will launch an additional Blood Lance at a Nearby enemy when it first hits an enemy that is already lanced, dealing [33-48%] of normal damage.',
  },
  {
    ...
    campaign: false,
    description:
      'Your Shadow Clones also mimic the Imbuements applied to your Skills. Casting an Imbuement Skill grants your active Shadow Clone x [5-20%] increased damage for 9 seconds.',
  },
  {
  ...
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Evade', 'Stealth'],
    description:
      'Evading through an enemy infected by Shadow Imbuement grants Stealth for 4 seconds. Breaking Stealth Heals you for [10-25%] of your Maximum Life.',
  },
  {
    ...
    filters: ['Core'],
    description:
      'Each point of Fury you generate while at Maximum Fury grants your next Core Skill within 5 seconds x [1-2%] increased damage, up to x [15-30%] .',
  },
  {
    ...
    filters: ['Barrier'],
    description:
      "The duration of Earthen Bulwark is increased by 6 seconds. In addition, killing an enemy with a Skill replenishes [X] of your active Earthen Bulwark's Barrier.",
  },
  {
  ...
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Chill', 'Poison', 'Freeze'],
    description:
      'Chilled enemies Poisoned by Poison Imbuement will be further Chilled for 20% per second. You deal x [15-30%] additional Poison damage to Frozen enemies.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Daze'],
    description:
      "You automatically drop a Smoke Grenade at the end of Dash. Smoke Grenades reduce Dash's cooldown by [0.5-0.65] seconds for each enemy hit, up to [1.50-1.95] seconds.",
  },
  {
  ...
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Overpower', 'Attack Speed'],
  ...
  },
  {
    ...
    filters: ['Mana'],
    description:
      'After spending [125-80] Mana your next Firewall is free to cast and will destroy incoming Small Missiles.',
  },
  {
    ...
    campaign: false,
    description:
      'The Ossified Essence Key Passive also increases the Critical Strike Damage of your Bone Skills by x1% per Essence above 50, up to x [25-40%] .',
  },
  {
    ...
    filters: ['Lucky Hit'],
    description:
      'Lucky Hit: When you hit a Crowd Controlled enemy, there is up to a [35-50%] chance for that Crowd Control effect to spread to another unaffected enemy.',
  },
  {
    ...
    filters: ['Burn'],
    description:
      "Meteorites fall around Meteor, dealing [30-45%] of Meteor's damage. Your Meteorites additionally Burn enemies they hit for [X] damage over 6 seconds.",
  },
  {
    ...
    filters: ['Barrier'],
    description:
      'Each time that Bone Storm damages an enemy, gain a Barrier equal to [1-6%] of your Maximum Life for 10 seconds.',
  },
  {
  ...
  },
  {
    ...
    location: 'Hawezar',
    filters: ['Lucky Hit', 'Vulnerable', 'Core'],
    description:
      'Lucky Hit: Damaging a Vulnerable enemy with a Non-Basic Skill has a [5-20%] chance to drop a Healing Potion.',
  },
  {
  ...
  },
  {
    ...
    location: 'Kehjistan',
    description:
      'Casting Lightning Spear always spawns an additional Lightning Spear and increases your damage with Shock Skills by x [10-25%] for 3 seconds.',
  },
  {
    ...
    filters: ['Heal'],
    description:
      'Each stack of Momentum Key Passive Heals you for [X] Life per second and grants you 5% Damage Reduction.',
  },
  {
    ...
    campaign: false,
    description:
      'Every 25 seconds, your next Upheaval cast is guaranteed to Overpower and deals x [10-25%] increased damage. This timer is reduced by 4 seconds when Upheaval Overpowers a Boss or an Elite enemy.',
  },
  {
    ...
    filters: ['Evade', 'Stun'],
    description:
      'When you Evade or Shadow Step, you leave behind a cluster of exploding Stun Grenades that deal [X] total Physical damage and Stun enemies for 1 second.\n\nYour Grenade Skills deal [25-40%] more damage.',
  },
  {
    ...
    location: 'Scosglen',
    description:
      "Bone Spirit's Critical Strike Chance is increased by + [10-25%] . Your Maximum Essence is increased by 2 for each enemy hit for 15 seconds.",
  },
  {
    ...
    campaign: false,
    description:
      'Using an Agility Skill reduces the Cooldown of your next Subterfuge Skill by 20%. Using a Subterfuge Skill increases the damage of your next Agility Skill by x [35-50%] .',
  },
  {
  ...
  },
  {
    ...
    campaign: false,
    description:
      "Landslide's earth pillars each strike a second time and deal an additional [5.5-13%] bonus damage per hit.",
  },
  {
    ...
    campaign: false,
    description:
      'Your Wolf Companions are now Werewolf Companions. Werewolf Companions deal x [100-130%] additional damage and can spread Rabies.',
  },
  {
    ...
    filters: ['Poison'],
    description:
      'While dashing, Shred seeks out Nearby Poisoned enemies and deals x [25-40%] increased damage to them.',
  },
  {
  ...
  },
  {
    ...
    dungeon: 'Conclave',
    location: 'Kehjistan',
    filters: ['Poison', 'Werebear', 'Werewolf', 'Crowd Controlled'],
    description:
      'You deal [25-55%] increased damage while hitting a Poisoned enemy as a Werebear or a Crowd Controlled enemy as a Werewolf.',
  },
  {
  ...
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Immobilize', 'Poison'],
    description:
      'Debilitating Roar is now a Werewolf Skill. In addition, Debilitating Roar will Immobilize Poisoned enemies for [2.5-4] seconds.',
  },
  {
    ...
    filters: ['Barrier'],
    description:
      'While you have a Barrier active, there is a [5-15%] chance to ignore incoming direct damage from Distant enemies.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Core'],
    description:
      'After attacking enemies with a Basic Skill, increase the damage of your next Core Skill cast within 5 seconds by x [5-10%] , up to x30%.',
  },
  {
  ...
  },
  {
    ...
    location: 'Dry Steppes',
    filters: ['Unstoppable', 'Damage Reduction'],
  ...
  },
  {
    ...
    campaign: false,
    description:
      'Lucky Hit: Your Shadow Damage Over Time effects have a [15-30%] chance to generate 3 Essence. Damage from your Shadowblight Key Passive will always generate 2 Essence.',
  },
  {
  ...
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Basic Skill', 'Attack Speed', 'Movement Speed'],
    description:
      'Damaging an enemy with a Basic Skill grants you 4% Attack Speed for 10 seconds, stacking up to 5 times. Upon reaching maximum stacks, you enter a Vampiric Bloodrage, gaining x [40-80%] Basic Skill damage and 15% Movement Speed for 10 seconds.',
  },
  {
    ...
    filters: ['Barrier'],
    description:
      'Damaging an Elite enemy grants you a Barrier absorbing up to [X] damage for 10 seconds. This effect can only happen once every 20 seconds.',
  },
  {
    ...
    location: 'Hawezar',
    description:
      'The duration of Grizzly Rage is increased by [3-8] seconds. In addition, Critical Strikes while Grizzly Rage is active increase your Critical Strike Damage by 10% for the duration, up to  a maximum of 200%.',
  },
  {
    ...
    location: 'Scosglen',
    description:
      'Gain [35-65%] increased Fury Generation and 15% reduced Fury cost to your Skills while all damage bonuses from the Walking Arsenal Key Passive are active.',
  },
  {
    ...
    filters: ['Vulnerable'],
    description:
      "Ice Blades' chance to apply Vulnerable is increased by 20% and the Vulnerable duration is increased by 4 seconds. You gain x [15-30%] Vulnerable Damage.",
  },
  {
  ...
  },
  {
    ...
    campaign: false,
    description:
      'Trample now summons 6 Landslide pillars of earth during its duration that deal [70-100%] normal damage. Trample is now also a Nature Magic and Earth Skill.',
  },
  {
  ...
  },
  {
    ...
    location: 'Fractured Peaks',
    description:
      'After killing an enemy with Shred, you gain 20 Spirit. Your Werewolf Skills deal [20-35%] increased damage when cast above 50 Spirit.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Healthy'],
    description:
      'Increases the Critical Strike Damage of Meteor and Fireball by x [25-40%] . Double this bonus against Healthy targets.',
  },
  {
  ...
  },
  {
    ...
    location: 'Scosglen',
    filters: ['Daze', 'Stealth'],
    description:
      'Dealing damage to a Dazed enemy with an Agility Skill grants Stealth for 4 seconds.\n\nWhen Stealth breaks, you gain [10-15%] Dodge Chance for 2 seconds.',
  },
  {
    ...
    filters: ['Core'],
    description:
      'Killing an enemy or hitting a Boss with a Core Skill refunds [15-30%] of its base Fury cost. Can only happen once per Skill cast.',
  },
  {
    ...
    location: 'Dry Steppes',
    description:
      'When casting an Imbuement Skill you trigger an explosion around yourself, applying the Imbuement effects and dealing [X] damage of the same type.',
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Heal', 'Overpower'],
    description:
      'Each percent of your Maximum Life you Heal beyond 100% grants you x0.5% bonus Critical Strike Damage on your next Critical Strike, up to a x [30-60%] bonus.',
  },
  {
    ...
    location: 'Dry Steppes',
    description:
      'When a Dark Shroud shadow is removed, you trigger an explosion that deals [X] Shadow damage and applies Shadow Imbuement to each enemy it hits.',
  },
  {
    name: 'Aphotic Aspect',
    class: 'Necromancer',
  ...
  },
  {
    ...
    campaign: false,
    description:
      'Lucky Hit: When your Conjuration Skills hit you have up to a [25-40%] chance to gain +1 Rank to your Conjuration skills for 12 seconds. This can stack up to 5 times.',
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Berserking', 'Weapon Swap'],
  ...
  },
  {
    ...
    filters: ['Berserking'],
    description:
      'Killing an enemy while Berserking has a 40% chance to grant [17-32%] increased Cooldown Reduction to your Brawling Skills for 2 seconds.',
  },
  {
    ...
    location: 'Scosglen',
    description:
      "Twisting Blades orbit for a short time after they return to you, dealing x [50-80%] of Twisting Blade's return damage per hit.",
  },
  {
    ...
    filters: ['Lucky Hit', 'Vulnerable'],
    description:
      'Lucky Hit: Dealing damage to enemies affected by your Trap skills has a [15-30%] chance to cause an explosion that deals [X] Shadow Damage and applies Vulnerable for 2 seconds.',
  },
  {
    ...
    location: 'Hawezar',
    description:
      'You deal [60-120%] increased damage for 6 seconds after the Shadowblight Key Passive damages enemies 10 times.',
  },
  {
    ...
    filters: ['Overpower'],
    description:
      'When your Core Skills Overpower an enemy, you spawn 3 Volatile Blood Drops. Collecting a Volatile Blood Drop causes it to explode, dealing [X] Physical damage around you.\n\nEvery 20 seconds, your next Skill is guaranteed to Overpower.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Movement Speed'],
    description:
      'Blood Mist leaves a trail of Desecrated Ground that lasts for 4 seconds and deals [X] Shadow damage per second. Gain 20% Movement Speed while Blood Mist is active.',
  },
  {
    ...
    campaign: false,
    description:
      'Whenever you cast a Shout Skill, its Cooldown is reduced by [1.0-2.0] seconds per Nearby enemy, up to a maximum of 6 seconds.',
  },
  {
    name: "Bold Chieftain's Aspect",
    class: 'Druid',
  ...
  },
  {
    ...
    location: 'Hawezar',
    description:
      'Enemies damaged by Kick or Charge will explode if they are killed within the next 2 seconds, dealing [X] damage to surrounding enemies.',
  },
  {
  ...
  },
  {
    ...
    location: 'Scosglen',
    filters: ['Movement Speed', 'Crackling Energy'],
  ...
  },
  {
    ...
    filters: ['Movement Speed'],
    description:
      'You take [10-25%] less damage from Crowd Controlled enemies. Whenever a Crowd Controlled enemy deals direct damage to you, gain 15% Movement Speed for 2 seconds.',
  },
  {
    ...
    filters: ['Chill'],
    description:
      'Every 8 seconds, your Skeletal Mages cast a blizzard that deals [X] Cold damage and continuously Chills enemies for 8% over 6 seconds.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Core'],
    description:
      'After generating 100 Fury, your next direct damage creates 2 Dust Devils that deal [X] damage to enemies along their path.',
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Movement Speed', 'Heal'],
    description:
      'Grizzly Rage now Shapeshifts you into a Dire Werewolf. As a Dire Werewolf you gain [10-25%] Movement Speed instead of Damage Reduction and [20-50%] Spirit cost reduction bonus. In addition, kills Heal you for 10% of your Maximum Life.',
  },
  {
  ...
  },
  {
    ...
    campaign: false,
    description:
      'Gain [10-25%] bonus amount to your next Earthen Bulwark for each enemy you Crowd Control up to a maximum of 100%.',
  },
  {
    ...
    campaign: false,
    description:
      'Ground Stomp creates an Earthquake damaging enemies for [X] Physical Damage over 4 seconds. While standing in Earthquakes, you deal x [10-25%] increased damage.',
  },
  {
    ...
    location: 'Hawezar',
    filters: ['Overpower', 'Weapon Swap'],
    description:
      'After swapping weapons 8 times, your next non-Basic Skill will Overpower and deal x [15-30%] increased Overpower damage.',
  },
  {
    ...
    location: 'Scosglen',
    description:
      'Skills deal up to x [5-20%] increased damage based on your available Primary Resource when cast, receiving the maximum benefit while you have full Primary Resource.',
  },
  {
    ...
    location: 'Dry Steppes',
    filters: ['Core', 'Mastery', 'Critical Strike Chance'],
  ...
  },
  {
    ...
    location: 'Fractured Peaks',
    filters: ['Injured', 'Unstoppable'],
    description:
      'Becoming lnjured while Crowd Controlled grants you Unstoppable for 4 seconds. This effect has a [40-25] second Cooldown.',
  },
  {
    name: 'Encased Aspect',
    class: 'Sorcerer',
  ...
  },
  {
    ...
    filters: ['Damage Reduction'],
    description:
      'Gain a free Dark Shroud shadow every 2 seconds when standing still. Each Dark Shroud shadow grants [2.5-4.0%] increased Damage Reduction.',
  },
  {
    ...
    filters: ['Dodge'],
    description:
      'Upon taking damage from surrounding enemies, you drop a Smoke Grenade and Dodge the next [2-7] attacks within 10 seconds. This effect can only occur once every 20 seconds.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Unstoppable'],
    description:
      'You have 20% increased Crowd Control Duration. While enemies are Unstoppable, you deal x [25-40%] increased damage to them.',
  },
  {
  ...
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Chill', 'Freeze'],
    description:
      'Enemies hit by your Grenade Skills have a chance equal to your Critical Strike Chance to be Frozen for 2 seconds.\n\nYou deal x [10-25%] increased Critical Strike Damage against Frozen or Stunned enemies.',
  },
  {
  ...
  },
  {
    ...
    location: 'Scosglen',
    filters: ['Unstoppable', 'Movement Speed'],
    description:
  ...
  },
  {
    ...
    filters: ['Blood Orb'],
    description:
      'Casting Blood Lance will consume Blood Orbs to also conjure lances from them. Each additional Blood Lance deals [20-50%] of normal damage and prioritizes targeting un-lanced enemies.',
  },
  {
  ...
  },
  {
    ...
    location: 'Kehjistan',
    description:
      'Your Golem has a [2-12%] chance to reduce its active Cooldown by 2 seconds and a [1-6%] chance to spawn a Corpse each time it damages an enemy with its normal attack.',
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Lucky Hit', 'Chill', 'Freeze'],
    description:
      'Lucky Hit: Shadow Imbued Skills have up to a 75% chance to release an explosion that deals [X] Cold damage to the target and surrounding enemies, Chilling them for 25%. If they were already Chilled or Frozen, increase this damage by x100%.',
  },
  {
  ...
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Poison', 'Stealth'],
    description:
      "Poison Trap no longer breaks Stealth and triggers no Cooldown or arm time while you are in Stealth. All Poision Traps activate when you exit Stealth and Poison Trap's Cooldown will be [8-5] seconds per trap placed.",
  },
  {
    ...
    location: 'Kehjistan',
    filters: ['Damage Reduction', 'Bleed'],
  ...
  },
  {
    ...
    filters: ['Lucky Hit', ''],
    description:
      'Gain [10-25%] increased Lucky Hit Chance while all damage bonuses from the Walking Arsenal Key Passive are active.',
  },
  {
    ...
    filters: ['Damage Reduction'],
    description:
      "The Vyr's Mastery Key Passive also grants x [6.0-9.0%] Damage Reduction, tripled while fighting a Close enemy.",
  },
  {
    name: 'Mangled Aspect',
    class: 'Druid',
  ...
  },
  {
    ...
    filters: ['Lucky Hit', 'Vulnerable'],
    description:
      'Lucky Hit: Dealing direct damage to a Vulnerable enemy has up to a [30-45%] chance to Daze them for 2 seconds.',
  },
  {
  ...
  },
  {
    ...
    location: 'Fractured Peaks',
    filters: ['Shout', 'Critical Strike Chance', 'Companion'],
    description:
      'Blood Howl is now a Shout Skill and increases Critical Strike Chance by [5-10%] . In addition, Blood Howl also affects Nearby Companions and Players for 3 seconds.',
  },
  {
    ...
    location: 'Kehjistan',
    filters: ['Stealth', 'Stun'],
    description:
      'When you enter or break Stealth, you drop a cluster of exploding Stun Grenades around you that deal [X] Physical damage and Stun enemies for 1 second.\n\nYour Grenade Skills deal [25-40%] more damage.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Healthy'],
    description:
      'When hit while not Healthy, a magical bubble is summoned around you for [2.5-5.0] seconds. While standing in the bubble, Players are Immune. Can only occur once every 90 seconds.',
  },
  {
    name: 'Rapid Aspect',
    new: false,
  ...
  },
  {
    ...
    campaign: false,
    description:
      'Shadow Step has an additional Charge. Killing an enemy with Shadow Step refunds a Charge and increases the damage of Shadow Step by x [2.5-10%] for 2 seconds, up to x [10-40%] .',
  },
  {
  ...
  },
  {
    ...
    campaign: false,
    description:
      'After you hit 15 enemies with your Shapeshifting Skills, your next Werebear Skill will deal x [40-55%] more damage and Stun enemies for 3 seconds.',
  },
  {
  ...
  },
  {
    ...
    location: 'Kehjistan',
    filters: ['Lucky Hit', 'Berserking', 'Core'],
    description:
      'Lucky Hit: Damaging an enemy with a Core Skill has up to a [15-30%] chance to extend the duration of Berserking by 2 second. Double this duration if it was a Critical Strike.',
  },
  {
    name: 'Requiem Aspect',
    class: 'Necromancer',
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Resistance', 'Elite'],
    description:
      "Breaking Concealment grants 10% Resistance and Maximum Resistance to all elements for 6 seconds.\n\nKilling an Elite enemy reduces Concealment's cooldown by [6-12] seconds.",
  },
  {
    name: 'Rotting Aspect',
    class: 'Necromancer',
    ...
    campaign: false,
    description:
      'Decompose can chain and burst up to 2 additional targets. Explosions from Decompose deals x15-30% increased damage.',
  },
  {
    ...
    campaign: false,
    description:
      'Critical Strikes with Storm Skills that you cast charge the air around you for 2 seconds causing a Lightning Bolt to periodically hit an enemy in the area for [X] Lightning damage. This duration can be extended by additional Critical Strikes.',
  },
  {
  ...
  },
  {
    ...
    campaign: false,
    description:
      'Earth Spike gains x [35-50%] bonus damage, launches spikes in a line, and has a [2-1] second Cooldown.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Essence'],
    description:
      'Casting Bone Spirit also launches 18 Bone Splinters in all directions, dealing x [200-500%] increased damage and generating 6 Essence per enemy hit.',
  },
  {
  ...
  },
  {
    ...
    campaign: false,
    description:
      'Pulverize creates a shockwave that travels forward, dealing [70-100%] of its damage to targets in the path.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Lucky Hit: You have up to a [45-60%] chance to gain 20 Fury when a Core Skill deals direct damage to at least one Bleeding enemy. Your Maximum Fury is increased by [5-20] .',
  },
  {
    name: 'Smiting Aspect',
    new: false,
    ...
    legendary: true,
    campaign: false,
    filters: ['Healthy', 'Injured'],
    description:
      'You have x [13-20%] increased Critical Strike Chance against Injured enemies. While you are Healthy, you gain x [25-40%] increased Crowd Control Duration.',
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Chill', 'Freeze', 'Barrier'],
    description:
      'Each Chilled or Frozen enemy you Evade through grants you a Barrier that absorbs [X] damage for 5 seconds, absorbing up to a maximum of [X] damage.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Vulnerable'],
    description:
      "Bone Spear's primary attack makes enemies hit beyond the first Vulnerable for 3 seconds. Bone Shards from Bone Spear deal [30-60%] bonus damage to Vulnerable enemies and pierce them.",
  },
  {
    name: 'Stable Aspect',
    class: 'Sorcerer',
    ...
    campaign: false,
    description:
      'While Unstable Currents is not active, your Shock Skills have a [6.5-114%] chance to trigger a free cast from it.',
  },
  {
  ...
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Lucky Hit', 'Fortify', 'Berserking'],
  ...
  },
  {
    ...
    location: 'Fractured Peaks',
    description:
      'Critical Strikes with Shred deal [15-30%] of the damage dealt as Lightning damage to the target and surrounding enemies.',
  },
  {
  ...
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Earth Skill', 'Poison'],
    description:
      "Poison Creeper's active also casts Landslide in a circle around you. Earth Skills deal x [15-30%] increased damage to Poisoned enemies.",
  },
  {
    ...
    campaign: false,
    description:
      "When the Nature's Fury Key Passive triggers a free Skill, your non Ultimate Cooldowns of the opposite type are reduced by [2.5-5] seconds.",
  },
  {
    name: 'Tidal Aspect',
    class: 'Necromancer',
  ...
  },
  {
    ...
    filters: ['Stun'],
    description:
      'Iron Maiden is now also a Darkness Skill and deals Shadow damage. Enemies afflicted by your Iron Maiden have a [10-25]% chance to be Stunned for 1 second when they deal direct damage.',
  },
  {
    ...
    filters: ['Lucky Hit', 'Poison'],
    description:
      'Lucky Hit: Shadow Imbued Skills have up to a 75% chance to create a toxic explosion that applies [X] Poisoning damage over 5 seconds to the target and surrounding enemies. If they were already Poisoned, increase this damage by x100%.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Stun'],
    description:
      'Caltrops also throw a cluster of exploding Stun Grenades that deal [X] total Physical damage and Stun enemies for 1 second.\n\nYour Grenade Skills deal [25-40%] more damage.',
  },
  {
    name: 'Umbrous Aspect',
    class: 'Rogue',
  ...
  },
  {
    ...
    location: 'Hawezar',
    filters: ['Damage Reduction', 'Attack Speed'],
    description:
      'While Army of the Dead is active, your Minions gain [70-100%] increased damage and take 90% reduced damage.',
  },
  {
    ...
    filters: ['Lucky Hit', 'Vulnerable'],
    description:
      "Lucky Hit: Damaging a Vulnerable enemy has a 25% chance to create an Arrow Storm at the enemy's location, dealing [X] Physical damage over 3 seconds.\n\nYour Arrow Storms deal x [30-40%] more damage.",
  },
  {
    ...
    filters: ['Core'],
    description:
      'Each time a Core Skill deals direct damage to an enemy, your next Charge, Leap, or Kick deals x [4-8%] increased damage, up to x [20-40%] .',
  },
  {
  ...
  },
  {
    ...
    filters: ['Cooldown'],
    description:
      'When Rabies infects an enemy, reduce its cooldown by [0.2-0.8] seconds. This cooldown reduction is tripled when infecting Elites.',
  },
  {
    ...
    campaign: false,
    description:
      'Your Rupture does not remove the Bleeding damage from enemies. This can occur once every [40-25] seconds.',
  },
  {
    ...
    legendary: true,
    campaign: false,
    filters: ['Lucky Hit', 'Stun'],
    description:
      'Your Weapon Mastery Skills have an additional Charge. Lucky Hit: Damaging an enemy with a Weapon Mastery Skill has up to a [40-55%] chance to Stun them for 2 seconds.',
  },
  {
  ...
  },
  {
    ...
    campaign: false,
    description:
      "While active, Counterattack reflects incoming Razor Wings back out again. Other Small Missiles arer also deflected back at enemies and deal [25-30%] of Counterattack's Base damage on impact.",
  },
  {
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Gorilla', 'Barrier', 'Armor', 'Resistance'],
    description:
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Block Reduction', 'Barrier'],
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Poison', 'Heal', 'Maximum Life'],
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Mobility Skill', 'Evade'],
    description:
      'Moving with a Mobility Skill or Evade drops Spirit Feathers along you which each deal [X] Lightning damage on impact.',
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Centipede Skill', 'Poison'],
    description:
      'Lucky Hit: Centipede Skills have up to a 35% chance to spawn a Pestilent Swarm from the target which deals [X] Poison damage per hit. Pestilent Swarms now also deal 100% of their Base damage as Poisoning damage over 6 seconds.',
  },
  {
    ...
    campaign: false,
    description:
      "Stinger spawns a Pestilence Swarm at its target location which deals [35-65%] of Stinger's Base damage per hit. Pestilent Swarms now last 100% longer and spiral outwards.",
  },
  {
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Resolve', 'Ferocity', 'Dodge'],
    description:
  ...
  },
  {
    ...
    filters: ['Focus Skill'],
    description:
      'Casting a Focus Skill recalls Nearby Spirit Feathers which deal [X] Lightning damage to enemies along their way. If there are no Nearby Spirit Feathers, the cast instead spawns 10 randomly around you.',
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Critical Strike Damage', 'Block Chance'],
    description:
      'Gain increased Critical Strike Damage equal [50-190%] of your Block Chance. Blocking doubles this bonus for 10 seconds.',
  },
  {
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Incarnate Skill', 'Invulnerable'],
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Poison', 'Critical Strike Chance', 'Eagle Skill'],
    description:
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Critical Strike Chance', 'Jaguar Skill'],
    description:
      'Your Critical Strike Chance with Jaguar Skills is increased against enemies by [1-8.5%] for each 10% of their missing Life.',
  },
  {
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Eagle Skill', 'Mobility Skill'],
    description:
      'Lucky Hit: Eagle Skills have up to a [25-30%] chance to summon a Spirit Feather. You can collect Spirit Feathers to reduce your Mobility Skill Cooldowns by 0.5 seconds.',
  },
  {
  ...
  },
  {
    ...
    filters: ['Slow', 'Fear'],
    description:
      'Once an enemy is Slowed by at least 80%, they also become Feared for 3 seconds. You deal [25-40%] increased damage to Feared enemies.',
  },
  {
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Centipede Skill', 'Poison', 'Crowd Control'],
    description:
      'Lucky Hit: Up to a 25% chance to create a Mystic Circle for 10 seconds. Casting a Centipede Skill in Mystic Circles empowers them to periodically apply [X] Poisoning damage over 6 seconds to enemies within while extending any Crowd Controls affecting them.',
  },
  {
  ...
  },
  {
    ...
    legendary: false,
    campaign: false,
    filters: ['Movement Speed', 'Incarnate Skill'],
    description:
