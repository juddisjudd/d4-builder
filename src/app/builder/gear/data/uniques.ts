export interface UniqueData {
  ...
  export const uniques: UniqueData[] = [
    ...
    },
    {
      ...
      effect: "Steel Grasp launches 2 additional chains. Enemies that have been pulled by Steel Grasp take x [40-60%] bonus damage from you for 5 seconds.",
    ...
    },
    {
      ...
      effect: "Increase Frenzy's maximum stacks by 2 . While you have maximum Frenzy, your other Skills gain [35-45%] increased Attack Speed.",
    ...
    },
    {
      ...
      effect: "Whirlwind explodes every 2 seconds and after it ends, dealing [40-50%] of the total Base damage dealt to surrounding enemies as Fire damage.",
    ...
    },
    {
      ...
      effect: "Death Blow creates a shockwave, dealing [24-38%] of its Base damage to enemies. Enemies who die to this effect also reset Death Blow's Cooldown.",
    ...
    },
    {
      ...
      effect: "Skills using this weapon deal [0.2-0.4%] increased damage per point of Fury you have, but you lose 2 Fury every second.",
    ...
    },
    {
      ...
      effect: "After spending 100 Fury within 3 seconds, your next cast of Hammer of the Ancients, Upheaval, or Death Blow within 5 seconds is a guaranteed Critical Strike and deals [10-30%] bonus Critical Strike Damage.",
    ...
    },
    {
      ...
      effect: "Rend's duration is increased by [2.0-4.0] seconds. Damaging enemies with Brawling Skills applies 2 stacks of Rend's Bleed. This effect can only occur once every 4 seconds per enemy.",
    ...
    },
    {
      ...
      effect: "When casting an Ultimate Skill and again 5 seconds after, you Pull in Distant enemies and deal [X] Physical damage to them. This damage is increased by x1% per 1 point of Willpower you have.",
    ...
    },
    {
      ...
      effect: "Landslide causes the ground to erupt in tectonic spikes which continue to deal [X] damage over 2 seconds.\nCasting Landslide in this area has a [20-30]% chance to cause additional Landslide pillars to spawn within.",
    ...
    },
    {
      ...
      effect: "Casting a Defensive Skill deals damage to Nearby Poisoned enemies, increased by x15% for every 100 Willpower you have.",
    ...
    },
    {
      ...
      effect: "Lucky Hit: Storm Skills have up to a [15-25%] chance to grant 4 Spirit. Your base Storm Skills are now also Werewolf Skills.",
    ...
    },
    {
      ...
      effect: "Gain Stealth for 2 seconds when killing enemies with Shred. Breaking Stealth with an attack grants Ambush which gaurantees Critical Strikes for [1.0-2.5] seconds.",
    ...
    },
    {
      ...
      effect: "Corpse Explosion consumes up to 4 additonal Corpses around the initial Corpse, dealing [X%] increased damage and with a [X%] larger radius per additional Corpse.",
    ...
    },
    {
      ...
      effect: "When you pick up [10-5] Blood Orbs, a free Bone Spirit is spawned, dealing bonus damage based on your current Life percent.",
    ...
    },
    {
      ...
      effect: "Lucky Hit: While you have an active Bone Storm, hitting an enemy outside of a Bone Storm has up to a [15-30%] chance to spawn an additional Bone Storm at their location. Each of your active Sacrifice bonuses increases the chance by 25% and the total number of additional Bone Storms you can have by 1.",
    ...
    },
    {
      ...
      effect: "You are Blood Lanced, and when Blood Lance would deal damage to you it instead Fortifies you for [1-2%] of your Maximum Life and has a 5% chance to form a Blood Orb. Blood Lance deals x [10-20%] increased damage.",
    ...
    },
    {
      ...
      effect: "Your Core Skills deal [20-40%] increased damage when spending 3 Combo Points. Your Skills using this weapon have a 30% chance to generate 3 Combo Points.",
    ...
    },
    {
      ...
      effect: "Penetrating Shot makes enemies Vulnerable for 3 seconds. Every 4th cast bounces off walls and scenery and deals x [50%-70%] bonus damage.",
    ...
    },
    {
      ...
      effect: "Unless it hits a Boss or Player, Death Trap deals [50-90%] increased damage and will re-arm iteself a second time, however the Cooldown is increased by [20-15%] .",
    ...
    },
    {
      ...
      effect: "Casting Flurry has a [15-30%] chance to release Stun Grenades that deal [X] Physical damage and Stun enemies for 1 second. Your Grenade Skills have a 2% Lucky Hit Chance.",
    ...
    },
    {
      ...
      effect: "The first direct damage you deal to an enemy is a guaranteed Critical Strike. When you consume Precision casting a Skill, that Skill gains x [20-40%] increased Critical Strike Damage and you gain [20-40] Energy.",
    ...
    },
    {
      ...
      effect: "Lucky Hit: Hits with this weapon have up to a [30-40%] chance to deal double damage and Knock Back the target.",
    ...
    },
    {
      ...
      effect: "Casting a Subterfuge Skill leaves behind a Decoy Trap that continuously Taunts and lures enemies. The Decoy Trap explodes after 3 seconds dealing [X] Shadow damage. Can occur every 6 seconds.",
    ...
    },
    {
      ...
      effect: "Lucky Hit: Damaging an enemy has up to a 30% chance of forming an exploding Ice Spike, dealing [0.25-0.35] Cold damage. Triple this chance if the enemy is Frozen.",
    ...
    },
    {
      ...
      effect: "Upon collecting Crackling Energy, there's a 15% chance to release a lightning nova, dealing [X] Lightning Damage, increased by x60% for every 100 Intelligence you have.",
    ...
    },
    {
      ...
      effect: "Fireball now bounces as it travels, exploding each time it hits the ground, but it's explosion deals [30-20%] less damage.",
    ...
    },
    {
      ...
      effect: "Meteor now has 2 charges with a [11.0-6.0] second Charge Cooldown instead of a Mana cost, and drops 3 additional meteors around the target.\nMeteor's Enchantment Effect and Enhanced Meteor drop 1 additional meteor.",
    ...
    },
    {
      ...
      effect: "For each type of Elemental damage you deal, gain [10-15%] increased damage for 4 seconds. Dealing Elemental damage refreshes all bonuses. Capped at four Elements.",
    ...
    },
    {
      ...
      effect: "Gain a random Shrine effect for [10-20] seconds after killing an Elite enemy. Can only occur once every 30 seconds.",
    ...
    },
    {
      ...
      effect: "Lucky Hit: Up to a [15-20%] chance to trigger a poison nova that applies [X] Poisoning damage over 5 seconds to enemies in the area.",
    ...
    },
    {
      ...
      effect: "Lucky Hit: Your Skills have up to a 20% chance to Freeze enemies for 3 seconds and deal [X] Cold damage to them.",
    ...
    },
    {
      ...
      effect: "Lucky Hit: Up to a [15-25%] chance to deal [X] Shadow damage to surrounding enemies and reduce their damage done by 20% for 5 seconds.",
    ...
    },
    {
      ...
      effect: "When you Stun, Freeze, or Immobilize an Elite enemy, or damage a Boss, it pulls in nearby enemies. You deal [30-60%] increased damage to them for 3 seconds. This effect can only occur once every 12 seconds.",
    ...
    },
    {
      ...
      effect: "Spending resources reduces your resource costs and increases your damage by x10% for 3 seconds, up to 50%.",
    ...
    },
    {
      ...
      effect: "Your Healing Potion no longer Heals instantly, instead it grants a Barrier for 200% of the healing for 4 seconds. While you have a Barrier, you gain [10-20%] Damage Reduction.",
    ...
    },
    {
      ...
      effect: "Lucky Hit: When you Critically Strike an enemy you have up to a 100% chance to Fear and Slow them by [61-75%] for 4 seconds.",
    ...
    },
    {
      ...
      effect: "Increases your Critical Strike Damage by [60-100%] . The other properties of this weapon can roll higher than normal.",
    ...
    },
    {
      ...
      effect: "Lucky Hit: Your damage over time effects have up to a 50% chance to erupt, dealing [5.0-6.0] damage of the same type to Nearby enemies.",
    ...
    },
    {
      ...
      effect: "Your Skills are all additionally Jaguar, Eagle, Gorilla or Centipede Skills based on your secondary Spirit Hall choice. Each Spirit type on a Skill increases its damage by 50%."
    },
    {
    ...
    },
    {
      ...
      effect: "Your Basic Skills deal [100-200%] increased damage, always use their 3rd attack, and every 3rd cast unleashes triple strikes.",
    ...
    },
    {
      ...
      effect: "Critical Strikes restore [10-30%] of the Vigor you have spent in the last 2 seconds, increased by your Critical Strike Damage Bonus. Gain Counterattack's Passive Effect."
    },
    {
      ...
      effect: "Your Maximum Vigor is increased by 100% and every kill grants [1-7] Vigor. Killing a Poisoned enemy grants a stack of Ferocity."
    }
  ];